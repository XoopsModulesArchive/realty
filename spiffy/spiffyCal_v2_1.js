...
function spiffyCalManager() {
	...
	this.Holidays = new Array("Dec-1","Dec-25","Jul-4", "Feb-14","Mar-17","Oct-31");
	this.HolidaysDesc = new Array("bazillyo@yahoo.com 's Birthday - send him money for this great calendar at www.paypal.com  :)","Christmas Day","Independance Day","Valentine's Day","St. Patrick's Day","Halloween");
