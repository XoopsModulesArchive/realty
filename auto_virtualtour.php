<?php
	...
	$sql = "SELECT ID, caption, description, file_name FROM " . $config[table_prefix] . "autovTourImages WHERE (auto_id = $autoID) ORDER BY rank";
	...
	$vtparams = " <param name=\"file\" value=\"ptviewer:$vtinit\"> \n";
		while (!$recordSet->EOF)
		{
			...
			$vtparams .= " <param name=\"pano$a\" value=\"{file=$config[auto_view_vTour_path]/$file_name}{auto=0.5}{pan=-45}{fov=95}\"> \n";
